...
export default function Hero() {
  const words = [
    ...
    'JavaScript Developer & OlovaJS Creator',
...
const profile = {
    name: 'Theara',
    title: 'JavaScript Developer | OlovaJS Creator | Web Designer',
    skills: [
        'React', 'Tailwind CSS', 'Bootstrap', 'JavaScript',
        'TypeScript', 'MySQL', 'HTML', 'CSS', 'UX/UI Design',
        'Graphic Design', 'Web Design', 'Git', 'Linux'
    ],
    hardWorker: true,
    quickLearner: true,
    problemSolver: true,
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  Web Design 🎨, UX/UI 💡, and Graphic Design 🖌️
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="https://github.com/theara24"
                ...
                {/* Contact Button */}
                <a
                  href="/assets/images/Resume.jpg" // Ensure this path is correct
                  download="Chim_Theara_Resume.jpg" // Suggested filename for the downloaded file
              ...
              <div className="hidden lg:block absolute right-10 top-20 animate-float">
                <div className="px-4 py-2 rounded-lg bg-blue-500/10 backdrop-blur-sm border border-blue-500/20 text-blue-400">
                  <i className="fas fa-code"></i>&nbsp;&nbsp;Grapich Design
                </div>
              </div>
              <div className="hidden lg:block absolute top-[17rem] left-[70%] transform -translate-x-1/2 animate-float">
                <div className="px-4 py-2 rounded-lg bg-amber-500/10 backdrop-blur-sm border border-amber-500/20 text-amber-400">
                  <i className="fas fa-lightbulb"></i>&nbsp;&nbsp;Frontend
                </div>
              </div>
            </div>
